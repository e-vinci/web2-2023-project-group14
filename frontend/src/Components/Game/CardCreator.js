...
export function createCards(scene) {
    ...
    const archerCardP1 = scene.add.image(scene.scale.width * 0.05, scene.scale.height * yValue, 'archerCard').setOrigin(0.5,0.5).setDepth(1).setScale(0.38);
    ...
    const botCardP1 = scene.add.image(scene.scale.width * 0.13, scene.scale.height * yValue, 'botCard').setOrigin(0.5,0.5).setDepth(1).setScale(0.38);
    botCardP1.setInteractive();
    botCardP1.on('pointerover', () => {botCardP1.setScale(0.45)});
    botCardP1.on('pointerout', () => {botCardP1.setScale(0.38)});

    const knightCardP1 = scene.add.image(scene.scale.width * 0.21, scene.scale.height * yValue, 'knightCard').setOrigin(0.5,0.5).setDepth(1).setScale(0.38);
    ...
    const necromancerCardP1 = scene.add.image(scene.scale.width * 0.29, scene.scale.height * yValue, 'necromancerCard').setOrigin(0.5,0.5).setDepth(1).setScale(0.38);
    ...
    const warriorCardP1 = scene.add.image(scene.scale.width * 0.37, scene.scale.height * yValue, 'warriorCard').setOrigin(0.5,0.5).setDepth(1).setScale(0.38);
    ...
    const warriorCardP2 = scene.add.image(scene.scale.width * 0.95, scene.scale.height * yValue, 'warriorCard').setOrigin(0.5,0.5).setDepth(1).setScale(0.38);
    ...
    const necromancerCardP2 = scene.add.image(scene.scale.width * 0.87, scene.scale.height * yValue, 'necromancerCard').setOrigin(0.5,0.5).setDepth(1).setScale(0.38);
    ...
    const knightCardP2 = scene.add.image(scene.scale.width * 0.79, scene.scale.height * yValue, 'knightCard').setOrigin(0.5,0.5).setDepth(1).setScale(0.38);
    ...
    const botCardP2 = scene.add.image(scene.scale.width * 0.71, scene.scale.height * yValue, 'botCard').setOrigin(0.5,0.5).setDepth(1).setScale(0.38);
    botCardP2.setInteractive();
    botCardP2.on('pointerover', () => {botCardP2.setScale(0.45)});
    botCardP2.on('pointerout', () => {botCardP2.setScale(0.38)});

    const archerCardP2 = scene.add.image(scene.scale.width * 0.63, scene.scale.height * yValue, 'archerCard').setOrigin(0.5,0.5).setDepth(1).setScale(0.38);
