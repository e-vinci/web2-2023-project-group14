...
export default class InstructionScene extends Phaser.Scene {
    ...
    create() {
        ...
        const backBtn = this.add.text(this.scale.width * 0.21, this.scale.height * 0.97, 'GO BACK TO MAIN MENU',
            {
        ...
        backBtn.on('pointerover', () => { backBtn.setFontSize(25); backBtn.setColor('#ffff99');});
        backBtn.on('pointerout', () =>  { backBtn.setFontSize(20);  backBtn.setColor('#ffffff');});
        ...
        // Logo golds setup
        const goldLogo = this.add.image(this.scale.width * 0.02, this.scale.height * 0.35, 'goldLogo').setOrigin(0,0.5).setScale(0.08);
        // Logo golds text
        const goldText = this.add.text(this.scale.width * 0.08, this.scale.height * 0.35, ': This icon reflects the amount of gold at your disposal for purchasing your fighter      units.' ,
        { 
            fontFamily: 'Blackletter, serif',
            fontSize: '20px',
            color: '#ffffff',
        ...
        const introText = this.add.text(this.scale.width * 0.04, this.scale.height * 0.15, text1 ,
        { 
            fontFamily: 'Blackletter, serif',
            fontSize: '20px',
            color: '#ffffff',
