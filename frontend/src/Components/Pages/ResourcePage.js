...
const ResourcePage = () =>{
    ...
    // Creation of the first section (Introduction Ressource Hub)
     const section1ResourceHub = document.createElement('div')
     const section1ResourceHubTitle = document.createElement('h1')
     section1ResourceHubTitle.textContent = 'Resource Hub';
     const section1RessourceHubContent = document.createElement('h4')
     ...
     section1RessourceHubContent.innerHTML = text1;

     section1ResourceHub.appendChild(section1ResourceHubTitle);
     section1ResourceHub.appendChild(section1RessourceHubContent);
     ...
     const section2AssetsContent = document.createElement('h4');
     ...
     <ul>
        <li> Exterminator:<a href="https://penusbmic.itch.io/sci-fi-character-pack-12" target="_blank"> Sci-Fi Character Pack 12 by penusbmic </a> </li>
        <li> Archer:<a href="https://legnops.itch.io/red-hood-character" target="_blank"> Red Hood Character by Legnops </a> </li>
        <li> Necromancer:<a href="https://creativekind.itch.io/necromancer-free" target="_blank"> Necromancer Free by CreativeKind </a> </li>
        <li> Warrior:<a href="https://creativekind.itch.io/nightborne-warrior" target="_blank"> Nightborne Warrior by CreativeKind </a></li>
        <li> Knight:<a href="https://chierit.itch.io/elementals-fire-knight" target="_blank"> Elementals: Fire Knight by Chierit</a> </li>
        <li> Player bases:<a href="https://creativekind.itch.io/flying-obelisk" target="_blank"> Flying Obelisk by CreativeKind </a> </li>
        <li> Map:<a href="https://www.reddit.com/r/inkarnate/comments/10ufx37/a_simple_grassland_encounter_map/" target="_blank"> A simple grassland encounter map by u/InkarnateOfficial</a> </li>
     </ul>`
     ...
     const section3SongsContent = document.createElement('h4');

     section3SongsTitle.textContent = 'Songs';
     const text3 = `The game uses the following songs for different scenes and scenarios:
     <ul>
        <li> Start of the game scene: <a href="https://www.youtube.com/watch?v=vx7S3v7u7jY" target="_blank"> “Fission” by Ludwig Göransson  </a></li>
        <li> Main game scene during fights: <a href="https://www.youtube.com/watch?v=atgjKEgSqSU" target="_blank"> “Aria Math (Minecraft Volume Beta)” by C418 </a></li>
        <li> Winner scene: <a href="https://www.youtube.com/watch?v=Y0Qfuqk2Q5g" target="_blank">“Casey Tells the Truth” by West Dylan Thordson </a> </li>
     </ul>
     ...
     const section4ImagesContent = document.createElement('h4');
